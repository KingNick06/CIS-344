        ...
        try:
            if self.path == '/addStudent':
                ...
                if self.path == '/addCourse':
                    ...
                    course_id = form.getvalue("cid")
                    self.database.addCourse(course_name, course_id)
                    '''
                        Example call: self.database.addCourse(course_name, course_id)
                    '''

                    print("grabbed values", course_name, course_id)
